...
#
#    (v 14.03.25, March 31, 2025 16:39:36)
#
...
api_logic_server__version = '14.03.25'
api_logic_server_created__on = 'March 31, 2025 16:39:36'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 14.03.25\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 14.03.25\n'
    msg += f'.. startup message: {start_up_message}\n'
